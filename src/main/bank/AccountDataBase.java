...
public class AccountDataBase {
	...
	public AccountDataBase(int id, int stat, String name, String address,
			Date birth, double creditStatus, String pin, int type) {
	...
	public void set(int id, int stat, String name, String address, Date birth,
			double creditStatus, String pin, int type) {
		this.id = id;
		this.stat = stat;
		this.name = name;
	...
	public String toString() {
		return id + "," + stat + "," + name + "," + address + ","
				+ (new SimpleDateFormat("yyyy-MM-dd")).format(birth) + ","
				+ type + "," + creditStatus + "," + pin + "," + fund + ","
				+ overdraft;
	}

	public void disp() {
		System.out.println("id=" + id + ", stat: " + stat + ", name=" + name
				+ ", address=" + address + ", birth="
				+ (new SimpleDateFormat("yyyy-MM-dd")).format(birth)
				+ ", type=" + type + ", creditStatus=" + creditStatus
				+ ", pin=" + pin + ", fund=" + fund + ", overdraft="
				+ overdraft);
	}
	...
	/*
	 * edit time 2015-4-29 23:04:48. add new function return true if
	 * amount<=fund+overdraft.
	 */
	public boolean checkOverdraft(double amount) {
		if (this.fund + this.overdraft >= amount&&amount<200)
			return true;
		else
			return false;
	}
	...
	/*
	 * edit time 2015-4-29 23:04:48. add new function return true if fund==0.
	 */
